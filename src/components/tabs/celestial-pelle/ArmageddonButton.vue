...
<template>
  ...
  >
    <span v-if="isHeader">你无法逃离已毁灭的现实！<br></span>
    ...
    <br>
    现实碎片
    <span class="c-reality-shard-gain">{{ format(realityShardGain, 2, 2) }}</span>/秒 ➜
    <span class="c-reality-shard-gain">{{ format(nextRealityShardGain, 2, 2) }}</span>/秒
  </button>
</template>
