...
2. `Tickspeed` 按语境处理：机制名译为“时间间隔”，升级译为“时间间隔升级”，主界面读数译为“维度生产频率”。
...
主界面曾将 `Tickspeed` 的每秒读数翻译为“游戏刻速率”或“每秒游戏刻数”，语义虽然接近代码，但中文玩家不容易理解，也不像游戏 UI 中会自然出现的指标名。

### 设计

1. 机制名按上下文译为“时间间隔”，购买项译为“时间间隔升级”。
2. 主界面数值读数统一译为“维度生产频率”，表达它实际影响维度生产节奏的用途。
3. 游戏玩法说明中可以保留“游戏刻”解释底层机制，但主界面避免直接暴露机械术语。

### 验收

1. 主界面顶部不再出现“游戏刻速率”。
2. 首屏应出现“维度生产频率”，不得再出现“每秒游戏刻数”。
